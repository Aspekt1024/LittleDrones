...
namespace Drawing {
	public static class Draw {
		...
		public static void Arrow (float3 from, float3 to, float3 up, float headFraction) {
			DrawingManager.Init();
			builder.Arrow(from, to, up, headFraction);
		}
		...
		/// <summary>
		/// \copydoc Drawing::CommandBuilder::WireRectangleXZ(float3,float3)
		/// Warning: This method cannot be used inside of Burst jobs. See job-system (view in online documentation for working links) instead.
		/// </summary>
		[BurstDiscard]

		public static void WireRectangleXZ (float3 center, float3 size) {
			DrawingManager.Init();
			builder.WireRectangleXZ(center, size);
		}

		/// <summary>
		/// \copydoc Drawing::CommandBuilder::WireRectangle(float3,Quaternion,float3)
		/// Warning: This method cannot be used inside of Burst jobs. See job-system (view in online documentation for working links) instead.
		/// </summary>
		[BurstDiscard]

		public static void WireRectangle (float3 center, Quaternion rotation, float3 size) {
			DrawingManager.Init();
		...
		public static void Arrow (float3 from, float3 to, float3 up, float headFraction, Color color) {
			DrawingManager.Init();
			builder.Arrow(from, to, up, headFraction, color);
		}
		...
		/// <summary>
		/// \copydoc Drawing::CommandBuilder::WireRectangleXZ(float3,float3,Color)
		/// Warning: This method cannot be used inside of Burst jobs. See job-system (view in online documentation for working links) instead.
		/// </summary>
		[BurstDiscard]

		public static void WireRectangleXZ (float3 center, float3 size, Color color) {
			DrawingManager.Init();
			builder.WireRectangleXZ(center, size, color);
		}

		/// <summary>
		/// \copydoc Drawing::CommandBuilder::WireRectangle(float3,Quaternion,float3,Color)
		/// Warning: This method cannot be used inside of Burst jobs. See job-system (view in online documentation for working links) instead.
		/// </summary>
		[BurstDiscard]

		public static void WireRectangle (float3 center, Quaternion rotation, float3 size, Color color) {
			DrawingManager.Init();
