	...
	public class DrawingData {
		...
		internal struct ProcessedBuilderData {
			...
			public void SchedulePersistFilter (int version, float time) {
				...
				if (temporaryMeshBuffers[0].splitterOutput.Length == 0) return;
		...
		public CommandBuilder GetBuilder (bool renderInGame = false) {
			return new CommandBuilder(this, Hasher.NotSupplied, frameRedrawScope, default, !renderInGame);
		}
		...
		public CommandBuilder GetBuilder (RedrawScope redrawScope, bool renderInGame = false) {
			return new CommandBuilder(this, Hasher.NotSupplied, frameRedrawScope, redrawScope, !renderInGame);
		}
		...
		public CommandBuilder GetBuilder (Hasher hasher, RedrawScope redrawScope = default, bool renderInGame = false) {
			...
			return new CommandBuilder(this, hasher, frameRedrawScope, redrawScope, !renderInGame);
		}
		...
		public void Render (Camera cam, bool allowGizmos, CommandBuffer commandBuffer) {
			...
			if (surfaceMaterial == null) surfaceMaterial = Resources.Load<Material>("aline_surface");
			if (lineMaterial == null) lineMaterial = Resources.Load<Material>("aline_outline");
			...
			if (surfaceMaterial == null || lineMaterial == null) {
				throw new System.Exception("Missing materials. The ALINE package installation seems to be corrupt. Try reinstalling the package.");
			}
