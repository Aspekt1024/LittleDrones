...
public class AstarPath : VersionedMonoBehaviour {
	...
	public static readonly System.Version Version = new System.Version(4, 3, 14);
	...
	public override void DrawGizmos () {
		...
		if (workItems.workItemsInProgress || isScanning) {
			...
			redrawScope = new RedrawScope(DrawingManager.instance.gizmos);
